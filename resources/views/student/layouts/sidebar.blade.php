<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="{{url('#')}}">
            <i class="fa fa-group"></i><span> Pendaftaran TA</span>
          </a>
        </li>
        <li>
          <a href="{{url('#')}}">
            <i class="fa fa-user-secret"></i><span> Menu 1</span>
          </a>
        </li>
        <li>
          <a href="{{url('#')}}">
            <i class="fa fa-rss"></i><span> Menu 2</span>
          </a>
        </li>
        <li>
          <a href="#">
            <i class="fa fa-book"></i><span> Menu 3</span>
          </a>
        </li>
        <li>
          <a href="#">
