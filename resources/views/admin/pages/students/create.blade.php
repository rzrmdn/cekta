...
<!-- Modal Tambah Data-->
<!-- <div class="modal fade" id="modal_students" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Nama Lengkap</label>
                    <input type="text" class="form-control" placeholder="Masukkan" value="{{ old('username') }}" name="nama">
                </div>
                <div class="form-group">
                    <label>NIM</label>
                    <input type="text" class="form-control" placeholder="Masukkan" value="{{ old('username') }}" name="nim"/>
                </div>
                <div class="form-group">
                    <label>Tempat Lahir</label>
                    <input type="text" class="form-control" placeholder="Masukkan" value="{{ old('username') }}" name="tempat_lahir"/>
                </div>
                <div class="form-group">
                    <label>Angkatan</label>
                    <input type="text" class="form-control" placeholder="Masukkan" value="{{ old('username') }}" name="angkatan"/>
                </div>
                <div class="form-group">
                    <label>Tanggal Lahir</label>
                ...
                <div class="form-group">
                    <label>Jenis Kelamin</label>
                    <select class="form-control" placeholder="Masukkan" value="{{ old('username') }}" name="jenis_kelamin">
                        <option value="Laki-laki">Laki-Laki</option>
                        <option value="Perempuan">Perempuan</option>
                    </select>
                </div>
                <div class="form-group">
                    <label>Alamat</label>
                    <input type="text" class="form-control" placeholder="Masukkan" value="{{ old('username') }}" name="alamat"/>
                </div>
                <div class="form-group">
                    <label>Email</label>
                    <input type="text" class="form-control" placeholder="Masukkan" value="{{ old('username') }}" name="email"/>
                </div>
                <div class="form-group">
                    <label>No. HP</label>
                    <input type="text" class="form-control" placeholder="Masukkan" value="{{ old('username') }}" name="no_hp"/>
                </div>
                <div class="form-group">
                    <label>Keterangan</label>
                    <input type="text" class="form-control" placeholder="Masukkan" value="{{ old('username') }}" name="keterangan">
                </div>
            </form>
        </div>
